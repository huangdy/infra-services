...
import com.leidos.xchangecore.core.infrastructure.service.impl.ResourceInstanceServiceImpl;
...
public class ResourceInstanceServiceTest
 ...
 //           msgCount1);
   ...
   //         msgCount1);
    ...
    @Test(expected = com.leidos.xchangecore.core.infrastructure.exceptions.ResourceInstanceDoesNotExist.class)
    ...
    @Test(expected = com.leidos.xchangecore.core.infrastructure.exceptions.ResourceProfileDoesNotExist.class)

...
import com.saic.uicds.core.infrastructure.messages.DeleteInterestGroupForRemoteCoreMessage;
    ...
    */
    ...
    public AgreementType createAgreement(AgreementType agreementType)
        ...
        try {
            ...
            if (agreement != null) {
                logger.debug("Persisted Agreement: " + agreement.getRemoteCore().getValue());
    ...
    private String getRealCoreName(String remoteCoreNameFQN) {
        ...
        return index != -1 ? remoteCoreNameFQN.substring(0, index)
                          : remoteCoreNameFQN;
    }

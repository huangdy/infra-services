...
public class DigestHelper
    ...
    public static EventType getFirstEventWithActivityNameIdentifier(DigestType digest) {
        ...
        for (ThingType thing : things) {
            if (thing instanceof EventType) {
                XmlObject[] ids = thing.selectChildren(IdentifierType.type.getName().getNamespaceURI(),
                    "Identifier");
                if (ids.length != 0) {
    ...
    public void setLocatedAt(String entityId, String locationId, Calendar cal) {
        ...
        if (cal != null) {
            ...
            try {
                ...
                StringBuffer buf = new StringBuffer(iso8601Format.format(cal.getTime()));
    ...
    public void setOccursAt(String eventId, String locationId, Calendar cal) {
        ...
        EventLocationRelationshipType occursAt = EventLocationRelationshipType.Factory.newInstance();
    ...
    public void setHasDestinationOf(String eventId, String locationId, Calendar cal) {
        ...
        EntityLocationRelationshipType hasDestinationOf = EntityLocationRelationshipType.Factory.newInstance();
    ...
    public void setInvolvedIn(String agentId, String eventId, Calendar cal) {
        ...
        AgentEventRelationshipType involvedIn = AgentEventRelationshipType.Factory.newInstance();
    ...
    public void setCauseOf(String causeId, String effectId) {
        ...
        CauseOfRelationshipType causeOf = CauseOfRelationshipType.Factory.newInstance();
    ...
    protected void addCircleToLocation(LocationType location,
        ...
        CircleByCenterPointType uCircle = CircleByCenterPointType.Factory.newInstance();
    ...
    public void addPolygonToLocation(LocationType location, net.opengis.gml.x32.PolygonType polygon) {
        ...
        if (polygon.getExterior().getAbstractRing() instanceof LinearRingType) {
            LinearRingType ring = (LinearRingType) polygon.getExterior().getAbstractRing();
    ...
    public static boolean objectHasWhatType(String codespace,
        ...
        boolean valueOk = false;
        boolean ok = false;
        XmlObject[] props = event.selectChildren(WhatType.type.getName().getNamespaceURI(), "What");
        for (XmlObject prop : props) {
            // System.out.println(prop);
            // Find the SimpleProperty with the correct codespace (there may be
            // more than one)
            XmlObject codespaceAttr = prop.selectAttribute(WhatType.type.getName().getNamespaceURI(),
                "codespace");
            if (codespaceAttr != null) {
                ...
                if (XmlUtil.getTextFromAny(codespaceAttr).equals(codespace)) {
                    ...
                    if (code != null) {
                        XmlObject codeAttr = prop.selectAttribute(WhatType.type.getName().getNamespaceURI(),
                            "code");
                    ...
                    if (label != null) {
                        XmlObject labelAttr = prop.selectAttribute(WhatType.type.getName().getNamespaceURI(),
                            "label");
    ...
    public static CauseOfRelationshipType getCauseByEffectID(DigestType digest, String effectID) {
        ...
        RelationshipType[] relationships = digest.getRelationshipAbstractArray();
        for (RelationshipType relationship : relationships) {
            if (relationship instanceof CauseOfRelationshipType) {
                ...
                if (causeOf.getEffect().getRef().size() > 0) {
                    String effectValue = (String) causeOf.getEffect().getRef().get(0);
    ...
    public static EventLocationRelationshipType getLocationRelationshipByTypeAndEventID(DigestType digest,
        ...
        XmlObject[] relationships = digest.selectChildren(EventLocationRelationshipType.type.getName().getNamespaceURI(),
            type);
